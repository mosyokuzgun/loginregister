...
public class SahayaBirak extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sahaya Bırak");
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast toast = Toast.makeText(SahayaBirak.this, "KOD " + qrcode, Toast.LENGTH_LONG);
            ...
            public void onClick(View view) {
                ...
                StringRequest request = new StringRequest(Request.Method.POST, uRL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast toast = Toast.makeText(SahayaBirak.this, response.trim(), Toast.LENGTH_LONG);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ;
                        Toast toast = Toast.makeText(SahayaBirak.this, "OKUNAMADI", Toast.LENGTH_LONG);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(SahayaBirak.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SahayaBirak.this,AppStartActivity.class));
        finish();
    }
}
...
public class AracaYukle extends AppCompatActivity implements LocationListener {
    ...
    double konum1;
    double konum2;
    String islem = "Araca Yüklendi";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportActionBar().setTitle("Araca Yükleme");
        ...
        setContentView(R.layout.activity_araca_yukle);
        ...
        ArizaKayit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AracaYukle.this, ArizaKayitOlustur.class);
    ...
    private void startScanning() {
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast toast = Toast.makeText(AracaYukle.this, "KOD " + qrcode, Toast.LENGTH_LONG);
        ...
        mCodeScannerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uRL = "https://tork.kumruscooter.com/qr/saha.php";
                StringRequest request = new StringRequest(Request.Method.POST, uRL, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                        Toast toast = Toast.makeText(AracaYukle.this, response.trim(), Toast.LENGTH_LONG);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ;
                        Toast toast = Toast.makeText(AracaYukle.this, "OKUNAMADI", Toast.LENGTH_LONG);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(AracaYukle.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(AracaYukle.this,AppStartActivity.class));
        finish();
    }
}
...
public class BataryaBirak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Batarya Bırakma");
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(BataryaBirak.this, qrcode, Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                StringRequest request = new StringRequest(Request.Method.POST, uRL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(BataryaBirak.this, response.trim(), Toast.LENGTH_LONG).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ;
                        Toast.makeText(BataryaBirak.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(BataryaBirak.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(BataryaBirak.this,AppStartActivity.class));
        finish();
    }
}